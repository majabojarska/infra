    ...
    oci-containers = {
      ...
      containers = {
        fibo = {
          ...
          ports = [
            "127.0.0.1:${toString config.sp6catVm01.ports.fibo}:${toString config.sp6catVm01.ports.fibo}"
          ];
          environment = {
            POSTGRESS_PASSWORD = "password";
            FIBO_DEBUG = "false";
            FIBO_API_ADDR = "0.0.0.0:${toString config.sp6catVm01.ports.fibo}";
            ...
            FIBO_METRICS_ADDR = "0.0.0.0:${toString config.sp6catVm01.ports.fibo}";
